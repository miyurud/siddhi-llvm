...
public:
  ...
  public:
    ...
    antlr4::tree::TerminalNode *OPEN_SQUARE_BRACKETS();
    Language_nameContext *language_name();
    antlr4::tree::TerminalNode *CLOSE_SQUARE_BRACKETS();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *FOLLOWED_BY();
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> OPEN_SQUARE_BRACKETS();
    antlr4::tree::TerminalNode* OPEN_SQUARE_BRACKETS(size_t i);
    std::vector<antlr4::tree::TerminalNode *> CLOSE_SQUARE_BRACKETS();
    antlr4::tree::TerminalNode* CLOSE_SQUARE_BRACKETS(size_t i);
